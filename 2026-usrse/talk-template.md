# USRSE’26 Talk Submission Template

Talks will be around 15 minutes including Q\&A. When submitting:
...
*Example: A Quick Introduction to Git Version Control*

## Authors

*Names, email, affiliations, and [ORCID](https://orcid.org/) of authors.*  
*Example:*  
...
*Max. 1 page (with reasonable font size, line spacing, and margins). Place References (if needed) in the final section in this template. Delete this paragraph.  The abstract, as submitted here, will be included in the conference program and published in the conference proceedings in Zenodo.*  

## References

*This section is optional. There is no limit to the number of references. “Gray literature” such as blog posts, educational videos, etc., are permissible. Any reference format is acceptable so long as a reviewer can successfully find the work referred.*  
*Example:*

1. *Pro Git, 2nd Edition. Scott Chacon and Ben Straub. Apress. December 2023\. Retrieved 2024-01-06. [https://git-scm.com/book/en/v2](https://git-scm.com/book/en/v2)*  
2. *Pro Git Supplement. Joshua Teves. November 2022\. Retrieved 2024-01-06. [https://joshuateves.com/pro\_git\_supplement.pdf](https://joshuateves.com/pro_git_supplement.pdf)*
